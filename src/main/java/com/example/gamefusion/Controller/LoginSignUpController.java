...
import com.example.gamefusion.Services.Implementations.MailService;
...
public class LoginSignUpController {
    ...
    @Autowired
    public LoginSignUpController( UserService userService, MailService mailService  )  {
...
//        userService.save( userDto ) ;
        return "redirect:/login-or-registration?success";
    }

    @GetMapping( "/otp-verification" ) 
    public String getOtpVerificationForm() {
    ...
    public String sent() {
        mailService.sentMail("vishnumm2003@gmail.com",new MailStructure("Test","success"));
        return "sent";
    }
